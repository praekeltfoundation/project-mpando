...
function FAQ() {
  return (
    <div className="Usage-guide">
      ...
      <img className="alignright" src="https://bettercare.co.za/wp-content/uploads/2015/04/ls-screenshot-ipad-mini-galaxy-y-300x297.png" alt="Bettercare Learning Station on iPad Mini and Samsung Galaxy Y" scale="0" width="157" height="155"/>
      <h2 className="Usage-guide__subheading">Click here to go to the Learning Station</h2>
      <h5 className="Usage-guide__strong">Read all of our learning programmes online for free!</h5>
      <ul>
